...
# declare kernels
lhc = MPIInstance.new('LHC', "#{dir}/LHC", mpi_args: '-np 2', java_class: 'examples.mpiring.LHC2')
psb = MPIInstance.new('PSB', "#{dir}/PSB", mpi_args: '-np 2', java_class: 'examples.mpiring.PSB2')
