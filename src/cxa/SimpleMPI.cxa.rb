...
cxa.env["r:dt"] = 1;
cxa.env["w:dt"] = 1;
cxa.env["w:command"] = ENV['MUSCLE_HOME'] + "/share/muscle/examples/simplempi/mpisender"
cxa.env["w:mpiexec_args"] = "-np 4"
cxa.env["cxa_path"] = File.dirname(__FILE__)

# declare kernels
cxa.add_kernel('w', 'muscle.core.standalone.MPIKernel')
