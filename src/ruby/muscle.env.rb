...
'logging_config_path' => File.join(base_dir, "src/resources/logging/logging.properties"),
...
e['muscle.behaviour.KillPlatformBehaviour'] = {"logging_after_teardown_properties_path" => File.join(base_dir, "src/resources/logging/logging.after_teardown.properties")}
