...
public class Array2D_boolean {
	...
	private boolean[] data;	//edit Array2D_double.java:4 instead
	...
	public Array2D_boolean(int newXSize, int newYSize) {
		...
		this(newXSize, newYSize, new boolean[newXSize*newYSize], IndexStrategy.FortranIndexStrategy.class);	//edit Array2D_double.java:8 instead
	}
	...
	//
	public Array2D_boolean(int newXSize, int newYSize, Class<? extends IndexStrategy> strategyClass) {
	
		this(newXSize, newYSize, new boolean[newXSize*newYSize], strategyClass);	//edit Array2D_double.java:10 instead
	}


	//
	public Array2D_boolean(int newXSize, int newYSize, boolean[] newData, Class<? extends IndexStrategy> strategyClass) {
