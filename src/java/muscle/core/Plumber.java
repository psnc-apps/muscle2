...
//		}
//
//		cs = ConnectionScheme.getInstance();
...
//		
//		ConduitArgs conduitArgs = new ConduitArgs(entrance, exit, optionalArgs);
...
//		String agentName = "conduit#"+conduitCounter+"["+entrance.getID().getOwnerID().getName()+":"+entrance.getID()+">-"+conduit.getClassName()+"("+conduit.getID()+")->"+exit.getLocalName()+":"+exit.getID()+"]";
