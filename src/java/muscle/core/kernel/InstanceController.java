 ...
 */
public class InstanceController extends MultiDataAgent implements SinkObserver<DataMessage<?>> {
	...
	final protected void setup() {
		...
		try {
			...
			Logger.getLogger(InstanceController.class.getName()).log(Level.SEVERE, null, ex);
