 ...
 */
public abstract class AbstractObservationFilter<E extends Serializable,F extends Serializable> extends AbstractFilter<Observation<E>,Observation<F>> implements ObservationFilter<E,F> {
