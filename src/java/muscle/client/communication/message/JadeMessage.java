...
@author Jan Hegewald
 */
public class JadeMessage<E> extends ACLMessage implements Cloneable {
	...
	public final static String DATA_KEY = JadeMessage.class.getName() + "#id";
	public final static String PORT_KEY = JadeMessage.class.getName() + "#portid";
	public final static String TYPE_KEY = JadeMessage.class.getName() + "#idtype";
